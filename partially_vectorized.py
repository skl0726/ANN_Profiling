...
def main():
    ...
    # Save figure
    plt.savefig("artificialneuralnetwork_partially_vectorized.png", dpi=240)
    # plt.show()
...
if __name__ == "__main__":
    if os.environ.get("SKIP_PROFILING") == "1":
        ...
        subprocess.run(["mprof", "plot", "-o", "mprof_plot_partially_vectorized.png"], capture_output=True)
        print("mprof_plot_partially_vectorized.png saved")


"""
python partially_vectorized.py | tee output_log_partially_vectorized.txt
"""