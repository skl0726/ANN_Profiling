...
def main():
    ...
    # Save figure
    plt.savefig("artificialneuralnetwork_fully_vectorized.png", dpi=240)
    # plt.show()
...
if __name__ == "__main__":
    if os.environ.get("SKIP_PROFILING") == "1":
        ...
        subprocess.run(["mprof", "plot", "-o", "mprof_plot_fully_vectorized.png"], capture_output=True)
        print("mprof_plot_fully_vectorized.png saved")


"""
python fully_vectorized.py | tee output_log_fully_vectorized.txt
"""